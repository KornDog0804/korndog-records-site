// SUPER AGGRESSIVE LOADING SCREEN FIX - Add this at the very top of your script.js
(function() {
  ...
  setTimeout(function() {
    ...
    if (loadingScreen) {
      ...
      console.log('Loading screen force-hidden by immediate timeout');
    }
  }, 2000); // 2 seconds
  ...
  document.addEventListener('DOMContentLoaded', function() {
    setTimeout(function() {
      ...
      if (loadingScreen) {
        loadingScreen.classList.add('hidden');
        console.log('Loading screen force-hidden by DOMContentLoaded');
      }
    }, 500);
  });
  ...
  window.addEventListener('load', function() {
    ...
    if (loadingScreen) {
      loadingScreen.classList.add('hidden');
      console.log('Loading screen force-hidden by window.load');
    }
  });
  ...
  const loadingCheckInterval = setInterval(function() {
    ...
    if (loadingScreen && !loadingScreen.classList.contains('hidden')) {
      loadingScreen.classList.add('hidden');
      console.log('Loading screen force-hidden by interval check #' + checkCount);
    }
  ...
  }, 1000); // Check every second, 5 times
})();

// Ensure admin is hidden by default
document.addEventListener('DOMContentLoaded', function() {
  // Hide admin button
...
function forceAdminAccess() {
  ...
  if (password === "KornDog2025!") { // You can change this password
    const adminBtn = document.getElementById('adminBtn');
    if (adminBtn) {
...
// Default products with your actual GitHub images
if (state.products.length === 0) {
  state.products = [
    // Vinyl Records - Zombie Kitty (Green)
    {
      id: 1,
    ...
    // Funko Pops - Chibi Kitty (White with X eye)
    {
      id: 6,
...
_Note: `1000043471-removebg-preview.png`, `1000044073-removebg-preview.png`, `ChatGPT Image Aug 10, 2025, 12_07_42 AM.png`, and 4 more were excluded from the analysis due to size limit. Please upload again or start a new conversation if your question is related to them._
